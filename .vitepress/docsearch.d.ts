...
export type DocSearchAskAi = Partial<Exclude<DocSearchPropsJS["askAi"], string | undefined>> & {
  /**
...
export type SidepanelProps = Partial<Pick<SidepanelPropsBase, "button" | "keyboardShortcuts">> & {
  /**
